...
public class Detector extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        final Rect r1 = new Rect(
                new Point(input.cols()*180f/330f, input.rows()*195f/330f),
                new Point(input.cols()*230f/330f, input.rows()*270f/330f));
...
//        telemetry.addData("Yellow percentage", Math.round(value2 * 100) + "%");
...
//        if (Math.round(value2 * 100) > 45) {
//            location = Location.YELLOW;
//        }
//        else if (Math.round(value2 * 100) > 10) {
//            location = Location.STRIPES;
//        } else {
//            location = Location.BLUE;
//        }
